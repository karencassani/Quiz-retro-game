...
function RightControl({ handleSelection, setMyPokeSelection, setPcPokeSelection }) {
    ...
    // Función para resetear la batalla y volver a la lista, al quedar vacios la logica de mi app principla volvera a mostrar la lista de pokemon
    const handleReset = () => {
        setMyPokeSelection([]);
        setPcPokeSelection([]);
    };
    ...
    return (
        /*Contenedor derecho, puse el color, borde redondeado*/
...
{/*contenedor de botones de accion X,Y,A,B */}
            <div className="mt-12 w-20 h-20 relative">
                {/*BOTON X AZUL : solo es estetico*/}
                <button 
...
{/*BOTON Y VERDE : solo es estetico*/}
                <button 
                ...
                {/* El botón A sigue siendo para SELECCIONAR e iniciar pelea es el amarillo */}
                <button 
